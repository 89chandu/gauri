...
import GauriProductSection from "./GauriProductSection";
  ...
  return (
    <>
      <Layout childrenClasses="pt-0">
        ...
        <TrustStrip />
        <ShopByCategory categories={homepage.homepage_categories} />
        {homepage && homepage.newArrivalProducts && homepage.newArrivalProducts.length > 0 && (
          <GauriProductSection
            products={homepage.newArrivalProducts}
            sectionTitle="Essential Pieces"
            eyebrow="The New Arrivals"
